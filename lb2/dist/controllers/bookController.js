...
export class BookController {
    ...
    static async apiList(req, res) {
        try {
            ...
            if (q.isAvailable === 'true')
                ...
                filters.isAvailable = false;
            if (q.isOverdue === 'true' || q.isOverdue === 'on' || q.isOverdue === '1')
                filters.isOverdue = true;
    ...
    static async apiBorrow(req, res) {
        try {
    ...
    static async apiReturn(req, res) {
        try {
