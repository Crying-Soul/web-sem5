...
function renderLeaderboard(list: ScoreEntry[], container: HTMLElement, showCurrent: boolean = false) {
    container.innerHTML = '';
...
function checkCollision(board: (string | null)[][], piece: Piece): boolean {
...
function createParticleSystem(x: number, y: number, color: string, count: number = 20) {
...
function renderPreview(ctx: CanvasRenderingContext2D, piece: Piece | null) {
